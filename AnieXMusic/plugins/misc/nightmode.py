...
async def _nightmode(_, message):
    return await message.reply_photo(photo="https://i.ibb.co/xgFmKwh/e2f7a9e14c74.jpg", caption="**ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴇɴᴀʙʟᴇ ᴏʀ ᴅɪsᴀʙʟᴇ ɴɪɢʜᴛᴍᴏᴅᴇ ɪɴ ᴛʜɪs ᴄʜᴀᴛ.**",reply_markup=buttons)
    ...
    for add_chat in chats:
        try:
            await app.send_photo(
                add_chat,
                photo="https://i.ibb.co/6B5npV6/e6e3b71418e3.jpg",
...
async def close_nightmode():
    ...
    for rm_chat in chats:
        try:
            await app.send_photo(
                rm_chat,
                photo="https://i.ibb.co/QYRrZWM/081f64a3a3ba.jpg",
